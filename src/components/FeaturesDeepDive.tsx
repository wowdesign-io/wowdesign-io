            ...
            <div className="features-typography-card">
              <div goo-stagger="0.3" goo="fade-up" goo-type="stagger" className="features-typography-card-single">
                ...
                <div className="features-title-description">
                  ...
                  <p className="features-description-text">We connect your CRM directly to your presales system — syncing live inventory, pricing, and availability to buyers while pushing every buyer interaction back into your sales team’s workflow automatically.</p>
                </div>
                <div className="features-list-wrapper">
                  <ul role="list" className="features-list">
                    <li className="features-list-item">
            ...
            <div className="features-typography-card">
              <div goo-stagger="0.3" goo="fade-up" goo-type="stagger" className="features-typography-card-single">
                ...
                <div className="features-title-description">
                  ...
                  <p className="features-description-text">Most developers have no idea which units are generating interest until buyers start calling. Our presales system tracks every view, click, and session — so your sales team always knows where demand is.</p>
                </div>
                <div className="features-list-wrapper">
                  <ul role="list" className="features-list">
                    <li className="features-list-item">
