            ...
            <div className="banner-world-element-tag-content">
              <div className="banner-world-element-tag-wrapper">
                <div className="banner-world-element-tag-single one">
                  ...
                  </div><img src="https://a.storyblok.com/f/293523249633085/625/7f3b1755ae/icon-sync.svg" loading="lazy" alt="" className="banner-world-element-tag-flag" />
                </div>
                <div className="banner-world-element-tag-single two">
                  ...
                  </div><img src="https://a.storyblok.com/f/293523249633085/937/9c13940808/icon-browsing.svg" loading="lazy" alt="" className="banner-world-element-tag-flag" />
                </div>
                <div className="banner-world-element-tag-single three">
                  ...
                  </div><img src="https://a.storyblok.com/f/293523249633085/1204/1e81530eac/icon-security.svg" loading="lazy" alt="" className="banner-world-element-tag-flag" />
                </div>
              </div>
            </div>
          ...
          <div data-goo-stagger="0.3" data-goo="fade-up" data-goo-type="stagger" className="w-layout-grid solving-grid">
            <div className="solving-grid-single _1st">
              ...
              <div className="solving-card four">
                <div className="solving-card-icon-wrapper"><img src="https://a.storyblok.com/f/293523249633085/2762/c18f029e08/icon-instant-mobile.svg" loading="lazy" alt="" className="solving-card-icon" /></div>
                <div className="solving-card-title-description">
            ...
            <div id="w-node-baf75690-0ea3-b0ee-d453-3abf3d4b5846-9046bfc6" className="solving-grid-single _2nd">
              <div className="solving-card two">
                <div className="solving-card-icon-wrapper"><img src="https://a.storyblok.com/f/293523249633085/1984/9119314e7f/icon-live-inventory.svg" loading="lazy" alt="" className="solving-card-icon" /></div>
                <div className="solving-card-title-description">
              ...
              <div className="solving-card five">
                <div className="solving-card-icon-wrapper"><img src="https://a.storyblok.com/f/293523249633085/2121/8f3eec9c7a/unit-specific-leads.svg" loading="lazy" alt="" className="solving-card-icon" /></div>
                <div className="solving-card-title-description">
            ...
            <div className="solving-grid-single _3rd">
              <div className="solving-card three">
                <div className="solving-card-icon-wrapper"><img src="https://a.storyblok.com/f/293523249633085/3315/6a828251ea/icon-dashboard.svg" loading="lazy" alt="" className="solving-card-icon" /></div>
                <div className="solving-card-title-description">
              ...
              <div className="solving-card six">
                <div className="solving-card-icon-wrapper"><img src="https://a.storyblok.com/f/293523249633085/1925/ef8261f8c6/icon-ada-compliance.svg" loading="lazy" alt="" className="solving-card-icon" /></div>
                <div className="solving-card-title-description">
          ...
          <div data-goo-stagger="0.3" data-goo="fade-up" data-goo-type="stagger" className="testimonial-top-content">
            <div className="testimonial-top-left-card">
              <div className="testimonial-single-card one">
                ...
                <div className="testimonial-author-wrapper">
                  <div className="testimonial-author-image-wrap"><img src="https://a.storyblok.com/f/293523249633085/2066/3142beb7d6/testimonial-claudia.avif" loading="lazy" alt="" className="testimonial-author-image" /></div>
              ...
              <div className="testimonial-single-card two">
                ...
                <div className="testimonial-author-wrapper">
                  <div className="testimonial-author-image-wrap"><img src="https://a.storyblok.com/f/293523249633085/2499/7652d662c6/testimonial-thomas.avif" loading="lazy" alt="" className="testimonial-author-image" /></div>
                  <div className="testimonial-author-name-bio-wrapper">
            ...
            <div className="testimonial-top-right-card">
              <div className="testimonial-single-card three">
                ...
                <div className="testimonial-author-wrapper">
                  <div className="testimonial-author-image-wrap"><img src="https://a.storyblok.com/f/293523249633085/2826/c272287635/testimonial-marcus.avif" loading="lazy" alt="" className="testimonial-author-image" /></div>
                  <div className="testimonial-author-name-bio-wrapper">
          ...
          <div data-goo-stagger="0.3" data-goo="fade-up" data-goo-type="stagger" className="testimonial-bottom-content">
            <div className="testimonial-bottom-left-card">
              <div className="testimonial-single-card four">
                ...
                <div className="testimonial-author-wrapper">
                  <div className="testimonial-author-image-wrap"><img src="https://a.storyblok.com/f/293523249633085/3059/95d1ce5482/testimonial-elena.avif" loading="lazy" alt="" className="testimonial-author-image" /></div>
                  <div className="testimonial-author-name-bio-wrapper">
            ...
            <div className="testimonial-single-card five">
              ...
              <div className="testimonial-author-wrapper">
                <div className="testimonial-author-image-wrap"><img src="https://a.storyblok.com/f/293523249633085/3857/c3f4bad641/testimonial-daniel.avif" loading="lazy" alt="" className="testimonial-author-image" /></div>
                <div className="testimonial-author-name-bio-wrapper">
            ...
            <div className="footer-information-wrapper">
              <div className="footer-information-single">
                <div className="footer-logo-description">
                  <a href="/" aria-current="page" className="footer-logo-link-block w-inline-block w--current"><img src="https://a.storyblok.com/f/293523249633085/8983/8b2fec33e4/wowdesign-logo-dark.svg" loading="lazy" alt="" className="footer-logo-image" /></a>
