...
<div className="page-wrapper">
    ...
    <section className="section_links10">
      <div className="padding-global">
        <div className="container-large">
          <div className="padding-section-large">
            <div className="links-card max-width-medium align-center">
                  ...
                  <div className="margin-vertical margin-xsmall">
                    <div className="links10_metatag-item">
                      <div className="links10_metatag-icon">
                        <div className="icon-embed-custom1 w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none" preserveAspectRatio="xMidYMid meet" aria-hidden="true" role="img">
              ...
              <div className="links10_component">
                <div className="links10_category-list">
                  <a href="/carry-cost-calculator" className="links10_item-link w-inline-block">
                    <div className="links10_icon-wrapper">
                      <div className="icon-embed-small text-color-primary w-embed"><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className="iconify iconify--ph" width="100%" height="100%" preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 256">
                          <g fill="currentColor">
                            <path d="M176 64v48H80V64Z" opacity=".2"></path>
                            <path d="M80 120h96a8 8 0 0 0 8-8V64a8 8 0 0 0-8-8H80a8 8 0 0 0-8 8v48a8 8 0 0 0 8 8m8-48h80v32H88Zm112-48H56a16 16 0 0 0-16 16v176a16 16 0 0 0 16 16h144a16 16 0 0 0 16-16V40a16 16 0 0 0-16-16m0 192H56V40h144Zm-100-68a12 12 0 1 1-12-12a12 12 0 0 1 12 12m40 0a12 12 0 1 1-12-12a12 12 0 0 1 12 12m40 0a12 12 0 1 1-12-12a12 12 0 0 1 12 12m-80 40a12 12 0 1 1-12-12a12 12 0 0 1 12 12m40 0a12 12 0 1 1-12-12a12 12 0 0 1 12 12m40 0a12 12 0 1 1-12-12a12 12 0 0 1 12 12"></path>
                          </g>
                        </svg></div>
                    </div>
                ...
                <div className="links10_category-wrapper">
                  <a href="/book-a-demo" target="_blank" className="button w-button">Book a Demo</a>
                  <a href="/" className="button w-button">wowdesign.io</a>
                </div>
                <div className="button-group">
                  <a href="/#newsletter" className="links10_newsletter-link w-inline-block">
                    <div id="w-node-_91be27b6-a9c3-a889-c5b8-dbfdf7569468-f896b363" className="links10_newsletter-icon-wrapper">
                      <div className="icon-embed-small w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none" preserveAspectRatio="xMidYMid meet" aria-hidden="true" role="img">
                ...
                <div className="links10_social-list">
                  <a href="https://www.instagram.com/wowdesign_miami/" target="_blank" className="links10_social-link w-inline-block">
                    <div className="icon-embed-small w-embed"><svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="https://www.linkedin.com/in/andy-bittner-wowdesign" target="_blank" className="links10_social-link w-inline-block">
                    <div className="icon-embed-small w-embed"><svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="https://www.youtube.com/@Andy_Bittner" target="_blank" className="links10_social-link w-inline-block">
                    <div className="icon-embed-small w-embed"><svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="links10_legal-links">
                  <a href="/privacy-policy" className="text-size-tiny">Privacy Policy</a>
